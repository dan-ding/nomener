...
RSpec.describe "WikiQuote parsing" do
  context "with the names of the form last, first" do
    [
      ...
      { from: "Balzac, Honoré de", to: { full: "Honoré de Balzac", first: "Honoré de", last: "Balzac"} },
      ...
      { from: "Beethoven, Ludwig van", to: { full: "Ludwig van Beethoven", first: "Ludwig van", last: "Beethoven"} },
      ...
      { from: "Bergerac, Cyrano de", to: { full: "Cyrano de Bergerac", first: "Cyrano de", last: "Bergerac"} },
      ...
      { from: "Braun, Wernher von", to: { full: "Wernher von Braun", first: "Wernher von", last: "Braun"} },
      ...
      { from: "Brothers, Dr. Joyce", to: { full: "Dr. Joyce Brothers", first: "Dr. Joyce", last: "Brothers"} },
      ...
      { from: "Browne, Sir Thomas", to: { full: "Sir Thomas Browne", first: "Sir Thomas", last: "Browne"} },
      ...
      { from: "Burton, Sir Richard Francis", to: { full: "Sir Richard Francis Burton", first: "Sir Richard Francis", last: "Burton"} },
      ...
      { from: "Cervantes, Miguel de", to: { full: "Miguel de Cervantes", first: "Miguel de", last: "Cervantes"} },
      ...
      { from: "Lon Chaney, Sr.", to: { full: "Sr. Lon Chaney", first: "Sr.", last: "Lon Chaney"} },
      ...
      { from: "Chateaubriand, François-René de", to: { full: "François-René de Chateaubriand", first: "François-René de", last: "Chateaubriand"} },
      ...
      { from: "Clausewitz, Karl von", to: { full: "Karl von Clausewitz", first: "Karl von", last: "Clausewitz"} },
      ...
      { from: "Crane, Dr. Frank", to: { full: "Dr. Frank Crane", first: "Dr. Frank", last: "Crane"} },
      ...
      { from: "DeWolfe, Ron (born L. Ron Hubbard, Jr.)", to: { full: "Jr.) DeWolfe, Ron (born L Ron Hubbard", first: "Jr.)", last: "DeWolfe, Ron (born L Ron Hubbard"} },
      ...
      { from: "Dyke, Henry van", to: { full: "Henry van Dyke", first: "Henry van", last: "Dyke"} },
      ...
      { from: "Foster, Sir Robert Sidney", to: { full: "Sir Robert Sidney Foster", first: "Sir Robert Sidney", last: "Foster"} },
      ...
      { from: "Gaulle, Charles de", to: { full: "Charles de Gaulle", first: "Charles de", last: "Gaulle"} },
      { from: "Gaultier, Jules de", to: { full: "Jules de Gaultier", first: "Jules de", last: "Gaultier"} },
      ...
      { from: "Goethe, Johann Wolfgang von", to: { full: "Johann Wolfgang von Goethe", first: "Johann Wolfgang von", last: "Goethe"} },
      { from: "Gogh, Vincent Willem Van", to: { full: "Vincent Willem Van Gogh", first: "Vincent Willem Van", last: "Gogh"} },
      ...
      { from: "Holmes, Oliver Wendell, Jr.", to: { full: "Jr. Holmes, Oliver Wendell", first: "Jr.", last: "Holmes, Oliver Wendell"} },
      { from: "Holmes, Oliver Wendell, Sr.", to: { full: "Sr. Holmes, Oliver Wendell", first: "Sr.", last: "Holmes, Oliver Wendell"} },
      ...
      { from: "Humboldt, Alexander von", to: { full: "Alexander von Humboldt", first: "Alexander von", last: "Humboldt"} },
      { from: "Humboldt, Wilhelm von", to: { full: "Wilhelm von Humboldt", first: "Wilhelm von", last: "Humboldt"} },
      ...
      { from: "Kennedy, Robert Francis Jr.", to: { full: "Robert Francis Jr. Kennedy", first: "Robert Francis Jr.", last: "Kennedy"} },
      ...
      { from: "La Bruyère, Jean de", to: { full: "Jean de La Bruyère", first: "Jean de", last: "La Bruyère"} },
      ...
      { from: "Lang, Will Jr.", to: { full: "Will Jr. Lang", first: "Will Jr.", last: "Lang"} },
      { from: "Lanne, Jack La", to: { full: "Jack La Lanne", first: "Jack La", last: "Lanne"} },
      ...
      { from: "La Rochefoucauld, François de", to: { full: "François de La Rochefoucauld", first: "François de", last: "La Rochefoucauld"} },
      ...
      { from: "Looney, General William", to: { full: "General William Looney", first: "General William", last: "Looney"} },
      ...
      { from: "Mallet, David (or David Malloch)", to: { full: "David (or David Malloch) Mallet", first: "David (or David Malloch)", last: "Mallet"} },
      ...
      { from: "Margera, Brandon \"Bam\"", to: { full: "Brandon \"Bam\" Margera", first: "Brandon \"Bam\"", last: "Margera"} },
      ...
      { from: "Martin, Judith \"Miss Manners\"", to: { full: "Judith \"Miss Manners\" Martin", first: "Judith \"Miss Manners\"", last: "Martin"} },
      ...
      { from: "Maupassant, Guy de", to: { full: "Guy de Maupassant", first: "Guy de", last: "Maupassant"} },
      ...
      { from: "Mayweather, Floyd, Jr.", to: { full: "Jr. Mayweather, Floyd", first: "Jr.", last: "Mayweather, Floyd"} },
      ...
      { from: "Miller, Walter M. (Jr.)", to: { full: "Walter M (Jr) Miller", first: "Walter M (Jr)", last: "Miller"} },
      ...
      { from: "Mises, Ludwig von", to: { full: "Ludwig von Mises", first: "Ludwig von", last: "Mises"} },
      ...
      { from: "Montaigne, Michel de", to: { full: "Michel de Montaigne", first: "Michel de", last: "Montaigne"} },
      { from: "Montesquieu, Charles de", to: { full: "Charles de Montesquieu", first: "Charles de", last: "Montesquieu"} },
      ...
      { from: "Peter, Dr. Laurence J.", to: { full: "Dr. Laurence J Peter", first: "Dr. Laurence J", last: "Peter"} },
      ...
      { from: "Raleigh, Sir Walter", to: { full: "Sir Walter Raleigh", first: "Sir Walter", last: "Raleigh"} },
      { from: "Ramirez, Manny", to: { full: "Manny Ramirez", first: "Manny", last: "Ramirez"} },
      { from: "Rand, Ayn", to: { full: "Ayn Rand", first: "Ayn", last: "Rand"} },
      { from: "Ranke, Leopold von", to: { full: "Leopold von Ranke", first: "Leopold von", last: "Ranke"} },
      ...
      { from: "Sade, Donatien de", to: { full: "Donatien de Sade", first: "Donatien de", last: "Sade"} },
      { from: "Sagan, Carl", to: { full: "Carl Sagan", first: "Carl", last: "Sagan"} },
      { from: "Saint-Exupéry, Antoine de", to: { full: "Antoine de Saint-Exupéry", first: "Antoine de", last: "Saint-Exupéry"} },
      { from: "Saint-Just, Louis de", to: { full: "Louis de Saint-Just", first: "Louis de", last: "Saint-Just"} },
      ...
      { from: "San Martín, José de", to: { full: "José de San Martín", first: "José de", last: "San Martín"} },
      ...
      { from: "Schiller, Friedrich von", to: { full: "Friedrich von Schiller", first: "Friedrich von", last: "Schiller"} },
      ...
      { from: "Snepscheut, Jan L. A. van de", to: { full: "Jan L A van de Snepscheut", first: "Jan L A van de", last: "Snepscheut"} },
      ...
      { from: "Speijk, Jan van", to: { full: "Jan van Speijk", first: "Jan van", last: "Speijk"} },
      ...
      { from: "Stoner Jr., James R.", to: { full: "James R Stoner Jr.", first: "James R", last: "Stoner Jr."} },
      ...
      { from: "Tocqueville, Alexis de", to: { full: "Alexis de Tocqueville", first: "Alexis de", last: "Tocqueville"} },
      ...
      { from: "Traficant, James A., Jr.", to: { full: "Jr. Traficant, James A", first: "Jr.", last: "Traficant, James A"} },
      ...
      { from: "Unamuno, Miguel de", to: { full: "Miguel de Unamuno", first: "Miguel de", last: "Unamuno"} },
      ...
      { from: "White, E. B. (Elwyn Brooks)", to: { full: "E B (Elwyn Brooks) White", first: "E B (Elwyn Brooks)", last: "White"} },
        ...
        it "parses #{name[:from]}" do
          ...
          parse_hash.each_pair do |k,v|
            unless (v.nil? || v.empty?)
              expect(v).to eq(name[:to][k]), "got from #{k} - #{v} wanted #{name[:to][k]}"
            end
          end
